...
void contact_callback(ConstContactsPtr& _msg)
{
  ...
  for (int i = 0; i < _msg->contact_size(); ++i)
  {
    ...
    if (((collision1.find("thorvald_ii") != std::string::npos) ||
         (collision2.find("thorvald_ii") != std::string::npos)))
    {
...
int main(int _argc, char** _argv)
{
  ...
  ros::param::param<std::string>("~actor_model_name", actor_model_name,
                                 "actor1");
  ros::param::param<std::string>("~queue_size", queue_size, "5");
  ros::param::param<std::string>("~loop_rate", loop_rate, "2500");
